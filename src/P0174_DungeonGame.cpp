...
int P0174_DungeonGame::calculateMinimumHP(vector<vector<int>> &dungeon) {
    ...
    for (int i = 0; i < rows; i++) {
        vector<int> vec(cols, INT_MAX);
        cost.push_back(vec);

        vector<int> vec2(cols, INT_MIN);
        cost2.push_back(vec2);
    }

    calculateMinimumHP_Sub(dungeon, cost, cost2, HP_curr, HP_sum, minHP, 0, 0, rows, cols);
    int result = minHP;
    return result;
}

void
P0174_DungeonGame::calculateMinimumHP_Sub(vector<vector<int>> &dungeon, vector<vector<int>> &cost,
                                          vector<vector<int>> &cost2, int HP_curr,
                                          int HP_sum,
                                          int &minHP, int i, int j, int rows, int cols) {
    times++;
    if (i == rows - 1 && j == cols - 1) {
//        cout << HP_curr << endl;
        HP_curr = HP_curr + dungeon[i][j];
        int dif = 0;
        if (HP_curr <= 0) {
            dif = 0 - HP_curr + 1;
            HP_curr = 1;
        ...
        minHP = min(HP_sum, minHP);
        cost[rows - 1][cols - 1] = min(cost[i][j], minHP);
        return;
    }
    if (i < rows - 1 || j < cols - 1) {     //未到达边界
        HP_curr = HP_curr + dungeon[i][j];
        int dif = 0;
        if (HP_curr <= 0) {
            dif = 0 - HP_curr + 1;
        ...
        /*******************************************/
        if ((HP_sum >= cost[i][j] && HP_curr <= cost2[i][j]) || (HP_sum >= cost[rows - 1][cols - 1]))
            return;
        if (cost[i][j] != INT_MAX) {
            if (HP_sum >= cost[i][j] && cost2[i][j] - cost[i][j] >= HP_curr - HP_sum)
                return;
        }
        if ((HP_sum <= cost[i][j] && HP_curr >= cost2[i][j]) ||
            (cost[i][j] != INT_MAX && HP_sum <= cost[i][j] && HP_sum - cost[i][j] + cost2[i][j] <= HP_curr)) {
            cost[i][j] = HP_sum;
            cost2[i][j] = HP_curr;
        }
        /*******************************************/
        ...
        if (i < rows - 1) {
            calculateMinimumHP_Sub(dungeon, cost, cost2, HP_curr, HP_sum, minHP, i + 1, j, rows, cols);
        }
        if (j < cols - 1) {
            calculateMinimumHP_Sub(dungeon, cost, cost2, HP_curr, HP_sum, minHP, i, j + 1, rows, cols);
        }
    }
}


int P0174_DungeonGame::test() {
    ...
    vector<vector<int>> dungeon2 =
            {{2,   -8,  -79, -88, -12, -87,  -5,  -56, -55,  -42,  18,  -91, 1,   -30,  -36, 42,  -96, -26,  -17, -69, 38,   18,  44,  -58,  -33, 20,  -45, -11,  11,  15,   -40,  -92, -62, -51,  -23, 20,  -86,  -2,  -90, -64, -100, -42, -16, -55, 29,  -62, -81,  -60,  7,    -5,  31,   -7,  40,  19,  -53, -81,  -77,  42,   -87, 37,   -43, 37,   -50, -21, -86, -28, 13,  -18, -65, -76},
             ...
             {-95, -73, -88, -4,  32,  7,    20,  19,  -17,  36,   -81, -91, -6,  -74,  20,  47,  -24, 15,   40,  -5,  -28,  -5,  23,  -30,  6,   -97, 49,  -12,  -57, 21,   1,    11,  -64, -32,  -95, -33, 10,   50,  47,  41,  -11,  -51, 22,  -84, 39,  10,  -36,  -72,  -27,  -60, -19,  -51, -11, 37,  2,   -62,  22,   -66,  -61, 29,   -50, -94,  48,  -23, 18,  -37, -92, -92, -4,  -97},
             {-81, 37,  19,  -5,  18,  15,   -34, -29, -84,  -35,  -67, -64, -57, -99,  46,  26,  -38, -37,  -79, 0,   -6,   32,  50,  37,   -63, 27,  -56, 11,   -3,  -66,  -72,  34,  13,  -4,   30,  -82, 32,   -71, -35, -30, 10,   -48, -93, -94, -92, -4,  -21,  -34,  -67,  -80, -98,  -28, 32,  -86, -22, 6,    46,   -75,  -40, -100, -7,  11,   -44, -12, -36, -24, 46,  -1,  26,  -20},
             {-81, -20, -54, -75, -78, 23,   -76, -90, 46,   -20,  -5,  30,  -59, -37,  -82, -68, 36,  8,    50,  -72, 48,   -97, -93, -10,  -31, -91, -81, -59,  27,  -47,  -65,  -75, -19, 26,   12,  41,  16,   -30, 33,  9,   -28,  -23, 45,  -32, -68, 39,  -24,  -89,  -47,  -41, -71,  -96, -45, -34, -43, -23,  39,   -32,  -99, -19,  46,  30,   -89, -8,  -65, -94, 42,  8,   -14, -50},
             {-49, -64, 20,  -6,  -82, -30,  -99, -79, -27,  -2,   -17, 30,  -14, 47,   -3,  -47, 31,  2,    -28, -7,  -83,  -56, -43, 11,   -46, -85, -17, -30,  -47, -84,  -88,  -36, 42,  -71,  -39, -28, 8,    -78, -39, 49,  8,    11,  37,  6,   -38, 33,  -36,  -36,  -37,  -44, -77,  41,  45,  -47, -63, -58,  -28,  -31,  -97, 23,   -94, -72,  35,  -39, -2,  27,  -87, 3,   13,  -66},
             {49,  27,  -43, -84, 27,  -93,  38,  25,  18,   43,   48,  49,  -35, -51,  28,  27,  2,   29,   0,   -47, -30,  -25, -90, -92,  -93, 0,   -73, -73,  0,   -62,  -73,  12,  -15, -40,  -50, 11,  -97,  -74, 42,  -55, -27,  -7,  49,  -32, -30, -6,  -54,  -88,  -73,  43,  -46,  -29, -50, -50, -11, 5,    23,   6,    12,  20,   -59, 47,   -98, -77, 47,  -5,  -17, 23,  -31, -14},
             {-28, 23,  -90, -47, 41,  32,   -38, 32,  -56,  -29,  -20, -34, -79, 41,   6,   -52, 41,  -43,  -24, -55, -81,  3,   -42, 6,    26,  31,  -64, 35,   7,   -85,  -38,  14,  -29, 8,    -88, 26,  -100, 9,   -11, -79, -59,  2,   38,  47,  23,  39,  46,   -65,  -62,  -61, 1,    43,  -58, -90, 33,  36,   -30,  38,   -11, -37,  19,  41,   -2,  -94, -8,  20,  -38, -82, -73, 28},
             ...
             {-98, -47, -87, -97, -82, 15,   9,   13,  -56,  35,   -7,  50,  -70, 34,   27,  3,   -24, -72,  -63, -56, -95,  -60, -59, 32,   -29, 31,  49,  43,   40,  -75,  -54,  3,   -87, -84,  -37, 46,  30,   -5,  -74, -36, -76,  -91, -40, 28,  -20, 26,  -78,  -27,  2,    44,  -24,  14,  -15, 29,  -86, -55,  24,   -80,  -24, 10,   -53, -98,  50,  -63, -61, 25,  -90, 24,  24,  -92}};
    ...
    times = 0;
    int result = calculateMinimumHP(dungeon2);
    cout << result << endl;
    cout << times << endl;
    return 0;
}
